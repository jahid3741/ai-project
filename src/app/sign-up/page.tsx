...
export default function Page() {
  return (
    <div className="flex min-h-screen bg-background">
      {/* LEFT COLUMN: Brand/Marketing for New Users (Hidden on Mobile) */}
      <div className="hidden lg:flex w-1/2 bg-primary flex-col justify-between p-12 text-primary-foreground relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[url('https://picsum.photos/1920/1080?random=6')] opacity-10 mix-blend-overlay pointer-events-none" />
        ...
        <div className="relative z-10 max-w-md animate-in slide-in-from-left-8 duration-700">
          ...
          <h1 className="text-4xl lg:text-5xl font-extrabold tracking-tight mb-8 leading-tight">
            Supercharge your tech career today.
          </h1>
          ...
          <div className="space-y-5">
            <div className="flex items-center gap-4">
              ...
              <p className="text-lg text-white/90 font-medium">
                Create unlimited ATS-friendly resumes
              </p>
            </div>
            <div className="flex items-center gap-4">
              <div className="bg-white/20 p-1.5 rounded-full">
              ...
              <p className="text-lg text-white/90 font-medium">
                Practice with elite AI mock interviewers
              </p>
            </div>
            <div className="flex items-center gap-4">
              <div className="bg-white/20 p-1.5 rounded-full">
              ...
              <p className="text-lg text-white/90 font-medium">
                Join 10,000+ engineers hired at FAANG
              </p>
            </div>
          </div>
        </div>
      ...
      {/* RIGHT COLUMN: Clerk Sign Up (Centered) */}
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
        ...
        <div className="w-full max-w-md animate-in fade-in zoom-in-95 duration-500 delay-150 fill-mode-both">
          {/* Added routing="hash" to fix the exact routing bug you had earlier! */}
          <SignUp
            routing="hash"
            appearance={{
              elements: {
