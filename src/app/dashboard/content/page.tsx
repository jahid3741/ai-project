...
export default function AIContentGenerator() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      setOutput("⚠️ Error: Could not connect to the backend. Make sure your Express server is running on port 4000 in your other terminal window!")
    } finally {
          ...
          <CardContent className="flex-1 p-6 overflow-y-auto">
            {output ? (
              ...
              <div className="h-full flex items-center justify-center text-muted-foreground text-sm italic">
                Your generated content from the Express backend will appear here...
              </div>
            )}
          </CardContent>
        </Card>
